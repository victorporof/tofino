...
window.addEventListener('load', event => {
  ...
  const url = 'http://localhost:9000/v1/chrome/?runnerConnId=%2Fv1%2Frunner%23k4cFvGGdjECa9trEAAAB&winId=2d12c846-3712-411b-8efb-f810683aa3ac&os=darwin&platform=qbrt';
